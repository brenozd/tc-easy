...
_add_route_shaping() {
    ...
    if _check_interface "$__ifb_dev"; then
    ...
    # TODO: Idealmente não devemos limitar a banda se n tiver __bandwidth, dessa forma o qdisc do NetEm se tornaria o root
